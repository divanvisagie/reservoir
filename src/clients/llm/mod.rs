...
fn openai_base_url() -> String {
    env::var(RSV_OPENAI_BASE_URL).unwrap_or_else(|_| "https://api.openai.com/v1/chat/completions".to_string())
}

fn ollama_base_url() -> String {
    env::var(RSV_OLLAMA_BASE_URL).unwrap_or_else(|_| "http://localhost:11434/v1/chat/completions".to_string())
}
